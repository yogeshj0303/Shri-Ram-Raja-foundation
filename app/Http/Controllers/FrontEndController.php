...
class FrontEndController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('index', compact('splits','volunteers','blogs','brands','services','categories','portfilos','testimonials' , 'languages' , 'events'));
    }
    ...
    public function blogdetails($id)
    {
        ...
        $recents = Event::orderBy('id','desc')->take(5)->get();
        return view('events-details',compact('blog','recents'));
    }
    ...
    public function allblog()
    {
        ...
        return view('events',compact('blogs' , 'events'));
    }
    ...
    public function about()
    {
        ...
        $pagedata = PageSettings::find(1);
        return view('about', compact('pagedata','portfolio'));
    }
    //About Page Data
    ...
    public function alldonates()
    {
        
        $alldonate = Donation::all();
