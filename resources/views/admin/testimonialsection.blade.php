                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="add-product-box">
                                    <div class="add-product-header products">
                                        <h2>Latest Youtube Url</h2>
                                        <a href="{!! url('admin/testimonial/create') !!}" class="add-newProduct-btn"><i class="fa fa-plus"></i>Add Latest Youtube Url</a>
                                    </div>
                                    <hr/>
                                            ...
                                            @foreach($testimonials as $testimonial)
                                                <tr>
                                                    <td>{{$testimonial->review}}</td>
                                                     ...
                                                     <td>{!! Embed::make($testimonial->client)->parseUrl()->setAttribute([
                    'width' => '100px',
                    'height' => '100px',
                    'frameborder' => 0,
