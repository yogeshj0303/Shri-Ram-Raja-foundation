                                ...
                                <div class="add-product-box">
                                    ...
                                    <form method="POST" action="{!! action('VolunteerController@update',['id' => $volunteer->id]) !!}" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="facebook" value="{{$volunteer->facebook}}" placeholder="e.g www.geniusocean.com" id="service_title3">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="service_title4">Google+ Link* </label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="google_plus" value="{{$volunteer->google_plus}}" placeholder="e.g www.geniusocean.com" id="service_title4">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="service_title5">Twitter Link* </label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="twitter" value="{{$volunteer->twitter}}" placeholder="e.g www.geniusocean.com" id="service_title5">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="service_title6">Linkedin Link* </label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="linkedin" value="{{$volunteer->linkedin}}" placeholder="e.g www.geniusocean.com" id="service_title6">
                                            </div>
                                        </div>
                                        <hr/>
