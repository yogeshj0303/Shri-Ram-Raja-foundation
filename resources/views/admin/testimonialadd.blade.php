                                ...
                                <div class="add-product-box">
                                    ...
                                    <form method="POST" action="{!! action('TestimonialController@store') !!}" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea name="review" id="clients_review" class="form-control" placeholder="Title" style="resize: vertical;" required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="clients_name">Youtube Url*</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="client" id="clients_name" placeholder="Url" required>
                                            </div>
                                        </div>
                                        
                                        <hr/>
                                        <div class="add-product-footer">
                                            <button name="addProduct_btn" type="submit" class="btn btn-success add-product_btn">Add</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
