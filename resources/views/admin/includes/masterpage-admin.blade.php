...
<head>
    ...
    <link rel="icon" type="image/png" href="{{url('/')}}/assets/logo/logo3.jpg" />
    <title>Aasra Society NGO Foundation - Admin Panel</title>
                ...
                <nav id="sidebar-menu">
                    ...
                    <ul class="list-unstyled components">
                        ...
                        <!--    </li>-->
                            ...
                            <li>
                                <a href="#serviceSection" class="submenu" data-toggle="collapse" aria-expanded="false"><i class="fa fa-fw fa-tasks"></i> Gallery</a>
                                <ul class="collapse list-unstyled" id="serviceSection">
                                    <li><a href="{!! url('admin/service') !!}">Gallery section content</a></li>
                                    <!--<li><a href="{!! url('admin/service/titles') !!}">Work section title</a></li>-->
                                </ul>
                            </li>
                            <!--<li>-->
                            ...
                            <!--</li>-->
                            <li>
                                <a href="#portfolioSection" class="submenu" data-toggle="collapse" aria-expanded="false"><i class="fa fa-fw fa-file-image-o"></i> Awards</a>
                                <ul class="collapse list-unstyled" id="portfolioSection">
                                    <li><a href="{!! url('admin/portfolio') !!}">Award section content</a></li>
                                    <li><a href="{!! url('/admin/portfolio/titles') !!}">Award section title</a></li>
                                </ul>
                            </li>
                            {{--<li>--}}
                        ...
                        @endif
                        <li>
                            <a href="#blogSection" class="submenu" data-toggle="collapse" aria-expanded="false"><i class="fa fa-fw fa-file-text"></i> Events</a>
                            <ul class="collapse list-unstyled" id="blogSection">
                                <li><a href="{!! url('admin/blog') !!}">Events  Content</a></li>
                                <li><a href="{!! url('admin/blog/titles') !!}">Events title</a></li>
                            </ul>
                        </li>
                        @if(Auth::user()->role == "administrator")
                            <li>
                                <a href="#testimonialSection" class="submenu" data-toggle="collapse" aria-expanded="false"><i class="fa fa-fw fa-quote-right"></i>Latest Video</a>
                                <ul class="collapse list-unstyled" id="testimonialSection">
                                    <li><a href="{!! url('admin/testimonial') !!}">Add Latest Youtube Video</a></li>
                            ...
                            <li>
                                ...
                                <ul class="collapse list-unstyled" id="pageSettings">
                                    ...
                                    <!--<li><a href="{!! url('admin/pagesettings/faq') !!}">What we Do</a></li>-->
