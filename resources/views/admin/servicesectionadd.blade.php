                                ...
                                <div class="add-product-box">
                                    ...
                                    <form method="POST" action="{!! action('ServiceSectionController@store') !!}" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="service_icon">Image*</label>
                                            <div class="col-sm-8">
                                                <input type="file" name="image" id="service_icon" accept="image/*" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="service_title">Image Title* <span>(In Any Language)</span></label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="add-product-footer">
                                            <button name="addProduct_btn" type="submit" class="btn btn-success add-product_btn">ADD Image</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
