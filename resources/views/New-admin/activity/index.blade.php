...
@endif
            <div class="search-div">
                ...
                <a href="{{route('activity.create')}}"><button type="button" style="float:right" class="mb-1 btn btn-pill btn-secondary"><span class"mdi-folder-plus-outline">Create Activity</span></button></a>
            </div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{{ $activity->link }}" target="_blank" class="">
                     {{ $activity->link }}
                </a>
            </td>
            <td>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="{{ route('activity.edit', $activity->id) }}">Edit Activity</a>

                        <form action="{{ route('activity.destroy', $activity->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="dropdown-item delete-media" data-confirm="Are you sure you want to delete this activity?">Delete Activity</button>
                        </form>
                    </div>
                </div>
            </td>
