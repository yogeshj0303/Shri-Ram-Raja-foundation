...
<form method="post" action="{{ route('editevents.update', $event->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="form-group row mb-6" id="fileInput">
        ...
        <div class="col-sm-8 col-lg-10">
            <input type="text" class="form-control" name="event_title" value="{{$event->event_title}}" placeholder="Enter Event Title">
        </div>
    </div>

      <div class="form-group row mb-6" id="fileInput">
        <label for="confirm_password" class="col-sm-4 col-lg-2 col-form-label">Current Event Image</label>
        <div class="col-sm-8 col-lg-10">
            @if($event->event_image)
                <img src="{{ asset('uploads/images/' . $event->event_image) }}" alt="Current Event Image" style="max-width: 200px;">
            @else
    ...
    <div class="form-group row mb-6" id="fileInput">
     ...
     <div class="form-group row mb-6" id="fileInput">
        ...
        <div class="col-sm-8 col-lg-10">
          <textarea class="form-control" name="event_desc" value="{{$event->event_desc}}">{{$event->event_desc}}</textarea>
