                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <form action="{{ route('Contact.destroy', $temp->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="dropdown-item delete-media" data-confirm="Are you sure you want to delete this media?">Delete Contact</button>
                                        </form>
                                        </div>
                                    </div>
                                </td>
